...
We will consider some of them to determine the form of files which contain external references. %TODO
...
The tools will be associated with languages, which was used to write scripts.
