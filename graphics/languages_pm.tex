...
\tikzstyle{sensor}=[draw, fill=green!20, minimum height=2.5em]
\tikzstyle{ann} = [above, text width=5em]
\tikzstyle{naveqs} = [sensor, text width=35em, fill=red!20, 
minimum height=18em, rounded corners]
\tikzstyle{lang} = [sensor, text width=9em, fill=blue!20, 
...
\node (l1pm1) at ([yshift=+15mm]lang1) [sensor] {Package manager 1};
\node (l1pm2) at ([yshift=0mm]lang1) [sensor] {Package manager 2};
\node (l1pmn) at ([yshift=-22mm]lang1) [sensor] {Package manager K};
\node at ($(l1pm2)!.5!(l1pmn)$) {\vdots};

\node (l2pm1) at ([yshift=+15mm]lang2) [sensor] {Package manager 1};
\node (l2pm2) at ([yshift=0mm]lang2) [sensor] {Package manager 2};
\node (l2pmn) at ([yshift=-22mm]lang2) [sensor] {Package manager L};
\node at ($(l2pm2)!.5!(l2pmn)$) {\vdots};

\node (lnpm1) at ([yshift=+15mm]langn) [sensor] {Package manager 1};
\node (lnpm2) at ([yshift=0mm]langn) [sensor] {Package manager 2};
\node (lnpmn) at ([yshift=-22mm]langn) [sensor] {Package manager M};
